...
export default function CreateListToggle() {
  ...
  return (
    <>
      ...
      >
        <span className="text-base leading-none">＋</span> 建立新清單
      </button>
          ...
          <div className="bg-white dark:bg-gray-900 w-full max-w-md p-6 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-800">
            ...
            >
              ...
              <div className="flex gap-2 pt-2">
                <button
                  type="submit"
                  className="flex-1 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-bold text-sm transition"
                >
                  立即建立
                </button>
                <button
